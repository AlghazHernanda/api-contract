...
import { getAiringTodayTVSeries, getPosterUrl, getBackdropUrl, formatDate } from '../services/movieService';
...
const AiringToday = () => {
  ...
  const handleSeriesClick = (series) => {
    // Navigate to TV series detail page
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Please wait while we fetch the TV series airing today...
              </p>
              ...
              <div style={{ padding: '1rem' }}>
                ...
                <p style={{ 
                  ...
                  <span style={{ 
                    ...
                    Popularity: {Math.round(series.popularity)}
                  </span>
                </p>
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <div style={{ position: 'relative', paddingBottom: '40%' }}>
              <img 
                src={getBackdropUrl(selectedSeries.backdrop_path)} 
            ...
            <div style={{ padding: '2rem' }}>
              <h2 style={{ margin: '0 0 1rem 0' }}>{selectedSeries.name}</h2>
              <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
                <p><strong>First Air Date:</strong> {formatDate(selectedSeries.first_air_date)}</p>
                <p><strong>Popularity:</strong> {Math.round(selectedSeries.popularity)}</p>
              </div>
              <p><strong>TV Series ID:</strong> {selectedSeries.id}</p>
            </div>
          </div>
        </div>
      )}
